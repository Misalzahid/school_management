                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="card">
                                    ...
                                    @foreach ($product->varients as $varients)
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="number" placeholder="Enter quantity" name="quantity[]"
                                                            id="quantity" value="{{ $varients->quantity }}"
                                                            class="form-control" required>
                                                        @error('quantity')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="col-sm-3 ">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="number" placeholder="Enter stock" name="total_stock[]"
                                                            id="stock" value="{{ $varients->total_stock }}"
                                                            class="form-control" required>
                                                        @error('total_stock')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
